...
public class Game {
	...
	public static final Cell[] cells = {
		...
		new Cell("成功廳",372,418,CellType.FATE).setScore(2).setMessage("猜兔子"),
		...
		new Cell("總圖書館",372,762,CellType.FATE).setScore(1).setMessage("知識王"),
		...
		new Cell("勝後",888,762,CellType.FATE).setScore(3).setMessage("接愛心"),
